...
export default function CalendarSpendingContent({date, setCurrentMode}) {

  const [data, setData] = useState([
    { id: 0, time: '09', pay: 15000, tag: 'tag', content: 'content'},
    { id: 1, time: '09', pay: 15000, tag: 'tag', content: 'content'},
    { id: 2, time: '09', pay: 15000, tag: 'tag', content: 'content'}
  ]);
